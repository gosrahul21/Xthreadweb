    ...
    <main className="flex flex-col">
      ...
      <header className="sticky top-0 z-50 border-b border-hair bg-ink/90 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          ...
          <a
            href="#cta"
            className="rounded-full bg-amber px-4 py-2 text-sm font-semibold text-ink transition-transform hover:scale-[1.03]"
          >
            Add to Chrome
          </a>
        </div>
        ...
        <div className="mx-auto grid max-w-6xl gap-14 px-6 pb-16 pt-16 md:grid-cols-2 md:items-center md:pt-24">
          <div>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-4">
              <a
                href="#cta"
                className="rounded-full bg-amber px-6 py-3 text-sm font-semibold text-ink shadow-[0_0_0_1px_rgba(0,0,0,0.05)] transition-transform hover:scale-[1.03]"
              >
      ...
      <section id="cta" className="relative overflow-hidden">
        <div className="mx-auto max-w-3xl px-6 py-24 text-center">
          ...
          <a
            href="#"
            className="mt-8 inline-block rounded-full bg-amber px-8 py-4 text-sm font-semibold text-ink transition-transform hover:scale-[1.03]"
          >
            Add to Chrome — it&apos;s free
          </a>
